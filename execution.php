...
<body id="page-top">
    ...
    <?php
        ...
        //         echo "OT_Number: " . $row["Description_OT"] . " - Name: " . $row["Description_OT"] . " - Age: " . $row["Description_OT"] . "<br>";
        //     }
        // } else {
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                      ...
                      <li class="nav-item dropdown no-arrow d-sm-none">
                        ...
                        <li class="nav-item dropdown mx-1">
                            <a class="nav-link " href="planfication.html" >
                                
                                <i class="fas ">Planfication </i>
                                <!-- Counter - Alerts -->
                               
                            </a>
                        </li>
                        <li class="nav-item dropdown mx-1">
                            <a class="nav-link " href="inspction.html" >
                                
                                <i class="fas ">Inspction</i>
                                <!-- Counter - Alerts -->
                               
                            </a>
                        </li>
                        <li class="nav-item dropdown mx-1">
                            <a class="nav-link " href="prepration.html" >
                                
                                <i class="fas ">Prepration </i>
                                <!-- Counter - Alerts -->
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">shaymaa elkhadraoui </span>
                ...
                <div class="container-fluid">
                    ...
                    <div class="master-container">
                        <div class="container-bourd"> 
                            <h3 class="title-dash"> </h3>
                        <div class="chart-pie-bourder">
                            
                            <div class="inline-pie-chart">

                         <div class="col-xl-4 col-lg-5">
                                <div class="card shadow mb-4">
                                    <!-- Card Header - Dropdown -->
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">Taux de realisation du calendrier preventif d'inspction</h6>
                                    </div>
                                    <!-- Card Body -->
                                    <div class="card-body">
                            ...
                            <div class="col-xl-4 col-lg-5">
                                <div class="card shadow mb-4">
                                    <!-- Card Header - Dropdown -->
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">Taux d'anomalies relevees par l'inspection</h6>
                                    </div>
                                    <!-- Card Body -->
                                    <div class="card-body">
                                        <div class="chart-pie pt-4">
                            ...
                            <div class="col-xl-4 col-lg-5">
                                <div class="card shadow mb-4">
                                    <!-- Card Header - Dropdown -->
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">Taux de realisation des ID issue de l'inspection </h6>
                                    </div>
                                    <!-- Card Body -->
                                    <div class="card-body">
                                        <div class="chart-pie pt-4">
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     ...
     <script src="js/demo/chart-pie-demoinspction.js"></script>
     <script src="js/demo/halfchart.js"></script>
